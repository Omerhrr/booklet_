...
class SalesService:
    ...
    def get_by_id(self, invoice_id: int, business_id: int) -> Optional[SalesInvoice]:
        return self.db.query(SalesInvoice).options(
...
class CreditNoteService:
    ...
    def get_by_id(self, credit_note_id: int, business_id: int) -> Optional[CreditNote]:
    ...
    def get_by_business(self, business_id: int) -> List[CreditNote]:
        return self.db.query(CreditNote).options(
            joinedload(CreditNote.customer)
        ).filter(
            CreditNote.business_id == business_id
