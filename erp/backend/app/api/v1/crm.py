...
async def create_customer(
    ...
    customer_service = CustomerService(db)
    customer = customer_service.create(customer_data, current_user.business_id)
    db.commit()
    return customer
...
async def get_customer(
    ...
    """Get customer by ID"""
    customer_service = CustomerService(db)
    customer = customer_service.get_by_id(customer_id, current_user.business_id)
    if not customer:
...
async def update_customer(
    ...
    """Update customer"""
    customer_service = CustomerService(db)
    customer = customer_service.update(customer_id, current_user.business_id, customer_data)
    if not customer:
        raise HTTPException(status_code=404, detail="Customer not found")
    db.commit()
    return customer
...
async def delete_customer(
    ...
    """Delete customer"""
    customer_service = CustomerService(db)
    if not customer_service.delete(customer_id, current_user.business_id):
        raise HTTPException(status_code=404, detail="Customer not found")
    db.commit()
...
async def create_vendor(
    ...
    """Create a new vendor"""
    vendor_service = VendorService(db)
    vendor = vendor_service.create(vendor_data, current_user.business_id)
    db.commit()
    return vendor
...
async def get_vendor(
    ...
    """Get vendor by ID"""
    vendor_service = VendorService(db)
    vendor = vendor_service.get_by_id(vendor_id, current_user.business_id)
    if not vendor:
...
async def update_vendor(
    ...
    """Update vendor"""
    vendor_service = VendorService(db)
    vendor = vendor_service.update(vendor_id, current_user.business_id, vendor_data)
    if not vendor:
        raise HTTPException(status_code=404, detail="Vendor not found")
    db.commit()
    return vendor
...
async def delete_vendor(
    ...
    """Delete vendor"""
    vendor_service = VendorService(db)
    if not vendor_service.delete(vendor_id, current_user.business_id):
        raise HTTPException(status_code=404, detail="Vendor not found")
    db.commit()
